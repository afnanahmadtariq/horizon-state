...
const allProperties: Record<string, {
    ...
    "the-aspen": {
        title: "The Aspen", price: "$2,400,000", layout: "Layout A", image: "/variety-layouts.png",
        ...
        gallery: ["/variety-layouts.png", "/architecture-exterior.png", "/testimonial-1.png"],
    },
    "the-sierra": {
        title: "The Sierra", price: "$1,850,000", layout: "Layout B", image: "/wellness-hub.png",
        ...
        gallery: ["/wellness-hub.png", "/flexible-furniture.png", "/hero-home.png"],
    },
    "the-ridge": {
        title: "The Ridge", price: "$3,100,000", layout: "Layout C", image: "/house-security.png",
        ...
        gallery: ["/house-security.png", "/hero-home.png", "/architecture-exterior.png"],
    },
    "the-valley": {
        title: "The Valley", price: "$1,600,000", layout: "Layout D", image: "/flexible-furniture.png",
        ...
        gallery: ["/flexible-furniture.png", "/wellness-hub.png", "/variety-layouts.png"],
    },
    "the-peak": {
        title: "The Peak", price: "$4,200,000", layout: "Custom", image: "/hero-home.png",
        ...
        gallery: ["/hero-home.png", "/house-security.png", "/architecture-exterior.png"],
    },
};
